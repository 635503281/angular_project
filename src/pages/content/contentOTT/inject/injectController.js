    ...
    module.exports=["$scope","$http","$translate","commonMethod","nodeService","contentService",
        ...
        $scope.init=()=>{
            ...
            $scope.item={
                ...
                urlType:1,//url类型,1-内容下载地址，2-内容上传地址
                duration:null,//"时长"
                mimeType:null,//媒体类型
                bitRate:null,// 码率
                size:null,//大小
        ...
        $scope.inject=()=>{
            ...
            let url=commonMethod.getServerUrl()+"/rest/content/ottContentInject";
