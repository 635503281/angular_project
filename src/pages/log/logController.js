...
(function(app){
    ...
    logCtrl.$inject=['$scope','$state','$rootScope','menuService'];
    function logCtrl($scope,$state,$rootScope,menuService){

        //初始化
        $scope.init=function(){
            //默认二级菜单，刷新还是当前菜单
            let defaultSecondMenuUrl=menuService.getFSecondMenu("index.log");
